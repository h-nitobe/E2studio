...
#define BSP_CFG_TAU_CK00 (TIMER_SOURCE_DIV_512) /* TAU CK00 Div /512 */
...
#define BSP_CFG_UARTA_CLOCK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_HOCO) /* UARTA Src: HOCO */
#define BSP_CFG_FSXP_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_LOCO) /* FSXP Src: LOCO */
